...
function news_vibrant_widgets_show_widget_field( $instance = '', $widget_field = '', $news_vibrant_widget_field_value = '' ) {
    ...
    switch ( $news_vibrant_widgets_field_type ) {
        ...
        <?php
            foreach ( $news_vibrant_widgets_field_options as $checkbox_option_name => $checkbox_option_title ) {
                if( isset( $news_vibrant_widget_field_value[$checkbox_option_name] ) ) {
                    $news_vibrant_widget_field_value[$checkbox_option_name] = 1;
                }else{
                    $news_vibrant_widget_field_value[$checkbox_option_name] = 0;
                }
            ?>
                <p>
                    <input id="<?php echo esc_attr( $instance->get_field_id( $news_vibrant_widgets_name .'-'. $checkbox_option_name ) ); ?>" name="<?php echo esc_attr( $instance->get_field_name( $news_vibrant_widgets_name ).'['.$checkbox_option_name.']' ); ?>" type="checkbox" value="1" <?php checked( '1', $news_vibrant_widget_field_value[$checkbox_option_name] ); ?>/>
        ...
        <?php            
            ...
            echo '</div>';
            echo '<input data-default="'.esc_attr( $news_vibrant_widget_field_value ).'" type="hidden" value="'.esc_attr( $news_vibrant_widget_field_value ).'" name="'.esc_attr( $instance->get_field_name( $news_vibrant_widgets_name ) ).'"/>';
            break;
